...
/**
  ...
  * - Gestión del watchdog (refresh solo cuando hay datos)
  * 
...
/**
  ...
  * 
  * @note   El watchdog solo se refresca cuando realmente se envían datos.
  *         Si el IMU deja de enviar datos por más de 1 segundo,
  *         el MCU se reiniciará automáticamente.
  */
