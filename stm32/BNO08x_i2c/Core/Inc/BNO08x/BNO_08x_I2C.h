...
#endif
// Address (STM32 HAL expects 8-bit addr = 7-bit << 1)
#define BNO_W_ADDR								((BNO08X_I2C_ADDR << 1) | 0x00)
#define BNO_R_ADDR								((BNO08X_I2C_ADDR << 1) | 0x01)
// DFU (bootloader) 7-bit address 0x29 -> 8-bit 0x52/0x53
#define ADDR_BNO_DFU_W_ADDR						(0x29 << 1)
#define ADDR_BNO_DFU_R_ADDR						((0x29 << 1) | 0x01)
...
// Request the Product ID from the sensor (sends REPORT_PRODUCT_ID_REQUEST)
